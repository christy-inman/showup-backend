      ...
      return knex('protests').insert([
        {
          ...
          description: 'In protest of the New York office wanting to dampen the ambitions of the Denver campus students and staff, we will be walking out to show support and solidarity for the current curriculum standards pushed in Denver.',
          donate: 'Venmo Link'
        },
        {
